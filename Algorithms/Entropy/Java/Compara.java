...
public class Compara {
    ...
    private static final int SAME_SIZE_VECTORS = 10;
    private static final String INSTANCE_PATH = "D://Zaaraki//CC//5 PERIODO//APA//Assignments//Algorithms//Entropy//instancias//"; // FULL PATH here to access parent folder.
    ...
    public static void main(String[] args) {
        ...
        sortVectorFromFile(INSTANCE_PATH, sort1, size1 - 1);
        sortVectorFromFile(INSTANCE_PATH, sort1, size2 - 1);
        sortVectorFromFile(INSTANCE_PATH, sort1, size3 - 1);
        statisticalFormatter.format("%s", "\n-----------------------------------------\n");

        sortVectorFromFile(INSTANCE_PATH, sort2, size1 - 1);
        sortVectorFromFile(INSTANCE_PATH, sort2, size2 - 1);
        sortVectorFromFile(INSTANCE_PATH, sort2, size3 - 1);
        statisticalFormatter.format("%s", "\n-----------------------------------------\n");

        sortVectorFromFile(INSTANCE_PATH, sort3, size1 - 1);
        sortVectorFromFile(INSTANCE_PATH, sort3, size2 - 1);
        sortVectorFromFile(INSTANCE_PATH, sort3, size3 - 1);
     ...
     */
    public static void sortVectorFromFile(String path, int sortedLevel, int size) {
        int v[] = new int[size];
        long begin, end;
...
//
//                case 1:
//                    sortingAlg.insertionSort(v);
//                    break;
//                case 2:
//                    sortingAlg.selection_sort(v, size);
//                    break;
//                case 3:
//                    sortingAlg.mergeSort(v);
//                    break;
//                case 4:
//                    sortingAlg.quickSort(v, 0, size - 1);
//                    break;
//                case 5:
//                    sortingAlg.heapsort(v, size - 1);
//                    break;
//            }
...
/*
            ...
            statisticalFormatter.format("%s\n", "Standard Algorithm " + "; Vector " + i + "; Sorted " + sortedLevel + "%; Size " + (size + 1)
